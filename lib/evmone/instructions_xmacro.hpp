...
#define MAP_OPCODES                                           \
    ...
    ON_OPCODE_IDENTIFIER(OP_PUSH0, push0)                     \
                                                              \
    ON_OPCODE_IDENTIFIER(OP_PUSH1, push1)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH2, push2)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH3, push3)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH4, push4)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH5, push5)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH6, push6)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH7, push7)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH8, push8)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH9, push9)                   \
    ON_OPCODE_IDENTIFIER(OP_PUSH10, push10)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH11, push11)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH12, push12)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH13, push13)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH14, push14)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH15, push15)                 \
                                                              \
    ON_OPCODE_IDENTIFIER(OP_PUSH16, push16)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH17, push17)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH18, push18)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH19, push19)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH20, push20)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH21, push21)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH22, push22)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH23, push23)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH24, push24)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH25, push25)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH26, push26)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH27, push27)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH28, push28)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH29, push29)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH30, push30)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH31, push31)                 \
    ON_OPCODE_IDENTIFIER(OP_PUSH32, push32)                 \
                                                              \
    ON_OPCODE_IDENTIFIER(OP_DUP1, dup1)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP2, dup2)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP3, dup3)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP4, dup4)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP5, dup5)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP6, dup6)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP7, dup7)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP8, dup8)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP9, dup9)                     \
    ON_OPCODE_IDENTIFIER(OP_DUP10, dup10)                   \
    ON_OPCODE_IDENTIFIER(OP_DUP11, dup11)                   \
    ON_OPCODE_IDENTIFIER(OP_DUP12, dup12)                   \
    ON_OPCODE_IDENTIFIER(OP_DUP13, dup13)                   \
    ON_OPCODE_IDENTIFIER(OP_DUP14, dup14)                   \
    ON_OPCODE_IDENTIFIER(OP_DUP15, dup15)                   \
    ON_OPCODE_IDENTIFIER(OP_DUP16, dup16)                   \
                                                              \
    ON_OPCODE_IDENTIFIER(OP_SWAP1, swap1)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP2, swap2)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP3, swap3)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP4, swap4)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP5, swap5)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP6, swap6)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP7, swap7)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP8, swap8)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP9, swap9)                   \
    ON_OPCODE_IDENTIFIER(OP_SWAP10, swap10)                 \
    ON_OPCODE_IDENTIFIER(OP_SWAP11, swap11)                 \
    ON_OPCODE_IDENTIFIER(OP_SWAP12, swap12)                 \
    ON_OPCODE_IDENTIFIER(OP_SWAP13, swap13)                 \
    ON_OPCODE_IDENTIFIER(OP_SWAP14, swap14)                 \
    ON_OPCODE_IDENTIFIER(OP_SWAP15, swap15)                 \
    ON_OPCODE_IDENTIFIER(OP_SWAP16, swap16)                 \
                                                              \
    ON_OPCODE_IDENTIFIER(OP_LOG0, log0)                     \
    ON_OPCODE_IDENTIFIER(OP_LOG1, log1)                     \
    ON_OPCODE_IDENTIFIER(OP_LOG2, log2)                     \
    ON_OPCODE_IDENTIFIER(OP_LOG3, log3)                     \
    ON_OPCODE_IDENTIFIER(OP_LOG4, log4)                     \
